...
/***/ "./src/app/services/categoty.service.ts":
/*!**********************************************!*\
  !*** ./src/app/services/categoty.service.ts ***!
  \**********************************************/
...
var CategoryService = /** @class */ (function (_super) {
    ...
    CategoryService.prototype.getCategories = function (perPage) {
...
var CommentService = /** @class */ (function (_super) {
    ...
    function CommentService(http) {
        var _this = _super.call(this, http, 'comments') || this;
        _this.http = http;
        return _this;
    }
    CommentService.prototype.getAllCommentsForPostById = function (postId, page) {
        return this.getItemList("post=" + postId, null, null, page, 10);
    };
    CommentService.prototype.addComment = function (postId, content, author, email, url) {
        if (url === void 0) { url = ""; }
        var body = {};
        if (postId) {
            body['post'] = postId;
